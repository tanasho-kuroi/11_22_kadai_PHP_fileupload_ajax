   ...
   $(function () {
      return $('body').on('click', '.checklist:not([readonly]) li:not([readonly])', function () {
         return (
            ...
            $(this).removeClass('checked completed').removeAttr('data-checked checked')
         );
      });
   }),
      $(function () {
            ...
            return (
               ...
               a.children().each(function () {
                  ...
                  return (
                     ...
                     !b && (d.hasClass('equal') || d.addClass('equal'), d.outerHeight() > c)
                        ? (c = d.outerHeight())
                        : void 0
                  );
               }),
         ...
         return (
            ...
            a.on('click', '.dropdown', function (a) {
               ...
               return (
                  ...
                  b.hasClass('focused') ? b.removeClass('focused') : b.trigger('dropdown')
               );
            }),
            a.on('click', function () {
               var a;
      ...
      (a = (function () {
         ...
         return (
            ...
            (a.prototype.defaultLabel = function () {
               return this.el.hasClass('nocollapse') || void 0 !== this.el.attr('title')
                  ? void 0
            ...
            (a.prototype.setupMarkers = function () {
               return (
                  ...
                  $(this.el).hasClass('vertical') || this.el.find('> ul').attr('role', 'menubar'),
      ...
      $(function () {
         ...
         return (
            (b = function () {
               return (
                  $('body').on('mouseenter', '.nav:not(.vertical) li[role="menu"]', function (a) {
                     var b, c;
                     return (
                        $('.nav:not(.vertical)')
                           .not(this)
                     ...
                     function (a) {
                        ...
                        return (
                           ...
                           'true' !== b.attr('aria-expanded')
                              ...
                              : (b.attr('aria-expanded', 'false'),
                                b.find('[aria-expanded="true"]').attr('aria-expanded', 'false')),
                           'true' !== c.attr('aria-pressed')
                              ? c.attr('aria-pressed', 'true')
                              : (c.attr('aria-pressed', 'false'),
                                c.find('[aria-pressed="true"]').attr('aria-pressed', 'false'),
                                c.find('[aria-expanded="true"]').attr('aria-expanded', 'false')),
                           a.preventDefault()
                        );
                     }
                  ),
                  $('body').on('click', '.nav button.hamburger', function (a) {
                     ...
                     return (
                        ...
                        'true' !== b.attr('aria-expanded')
                           ? b.attr('aria-expanded', 'true')
                           : (b.attr('aria-expanded', 'false'),
                             b.find('[aria-pressed="true"]').attr('aria-pressed', 'false'),
                             b.find('[aria-expanded="true"]').attr('aria-expanded', 'false')),
                        a.preventDefault()
                     );
                  })
                  ...
                  a.each(function () {
                     return $(this).hasClass('vertical') &&
                        ...
                        ? ($(this)
                             ...
                             .css({ 'padding-left': $(this).children('ul').width() + 10 + 'px' }),
                          $(this)
                             .children('ul')
                  ...
                  $(this.el).hover(
                     function () {
                        return (
                           ...
                           a.difference > a.scrollSpeed && (a.scrollSpeed = a.difference),
                           a.difference > 0
            ...
            (a.prototype.addNumberWordsThatFit = function () {
               ...
               for (
                  ...
                  this.addWords(a + c),
                     ...
                     (c = Math.floor(c / 2) || 1);
               return (
                  this.addWords(a), $(this.el).html(this.trimTrailingPunctuation($(this.el).html()))
               );
            }),
