...
// delete_flagとis_adminは初期値０
$sql = 'INSERT INTO users_table(id, username, password, is_admin, delete_flag, created_at, updated_at) VALUES(NULL, :username, :password, 0, 0, sysdate(), sysdate())';
